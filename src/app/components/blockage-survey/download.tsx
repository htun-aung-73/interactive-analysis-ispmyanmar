...
export default function DownloadSection({content}: {content: DownloadContent[]}) {
    return (
        <div className={'mt-10 flex flex-col justify-center items-center bg-gray-100 p-5 lg:w-2/3 mx-auto'}>
